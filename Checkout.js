...
cart.forEach((cartItem) => {
    ...
    if (matchingProduct) {
        ...
        console.error(`Product with ID ${productId} not found in the product list.`);
    }
});

// Injecter le HTML généré dans l'élément avec la classe js-order-summary
document.querySelector('.js-order-summary').innerHTML = cartSummaryHTML;

// Ajouter un écouteur d'événements pour chaque lien de suppression
